    ...
    <main className="px-2.5 md:px-8 py-2 md:py-10 lg:py-5 lg:px-[1.5vw]">
      <section className="py-4 lg:flex lg:justify-between lg:items-center lg:py-8">
        ...
        <section className="hidden lg:block lg:w-1/2 lg:p-6 lg:m-auto lg:bg-gray-400">
          <img src={mainImage} alt="a happy girl eating something" className="w-full" />
        </section>
      </section>
      <section className="py-4 md:py-6 flex flex-col justify-around gap-4">
        ...
        <section className="py-4 md:py-6 lg:py-2 flex justify-center items-center">
          <Card />
        </section>
      </section>
      <section className="flex flex-col lg:flex-row justify-around lg:justify-between lg:items-center gap-4 lg:gap-8 md:py-6 lg:py-8">
        ...
        <section className="py-4 md:py-8 flex flex-col justify-around items-start gap-6 md:gap-10 lg:gap-12 lg:w-1/2 lg:py-8">
          ...
          <button className="rounded-full px-10 md:px-16 lg:px-12 py-3 md:py-6 lg:py-4 text-white text-lg md:text-3xl lg:text-xl font-semibold bg-orange-500">About Us</button>
        </section>
      </section>
      <section className="py-4 md:py-6 lg:py-4 flex flex-col justify-around items-start gap-6 md:gap-8 lg:gap-4">
        ...
        <section className="py-4 lg:py-2 flex justify-center items-center">
          <Card />
        </section>
      </section>
    </main>
